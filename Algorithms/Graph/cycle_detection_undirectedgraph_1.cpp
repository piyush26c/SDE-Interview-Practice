...
/*
	below code will not work if graph as more than one components (means) a graph is composition of two or more connected graphs, but itself not a single componenet(akhand graph nahi aahe)
*/
